...
public abstract class XmlaOlap4jCellSet implements CellSet {
    ...
    enum XsdTypes {
        ...
        static {
            Map<String, XsdTypes> typesInitial = new HashMap<String, XsdTypes>();
    ...
    byte[] populateSap() throws OlapException {
    	return olap4jStatement.getBytes();
    }
    /**
...
//        System.out.println(ss);
        //System.out.println(ss.substring(0, 1024*128));
        Document doc;
        try {
//        	File f = new File("d:/test.xml");
//            OutputStream os = new FileOutputStream("d:/test3.xml");
//            os.write(bytes);
//            os.flush();
//            os.close();
            doc = parse(bytes);
    ...
    public void setDataBuf(Object buf){
    	m_dataBuf = buf;
    }
    public Object getDataBuf(){
    	return m_dataBuf;
    }
    /**
