...
public class CreateHdfsFile extends Function {
	...
	static{
		{
		    ...
		    //String envUser = System.getProperty("HADOOP_USER_NAME");		        
		    //System.out.println("Current user444 is " + envUser);
			envPath = path + ";" + envPath;
			path = path.replace("\\bin", ""); 
			
			//System.out.println("user_dir:" + path); 
	...
	public Object calculate(Context ctx) {
		...
		try {
			...
			//URL fo = new URL(pathName);
			HdfsClient client = new HdfsClient(ctx, xmlfiles, url);			
			HdfsFile file = new HdfsFile(client, path);
