...
public class ImMarginSecStocks extends ImFunction {
	public Node optimize(Context ctx) {
		return this;
	}
	//get_marginsec_stocks(token,date)
	public Object doQuery(Object[] objs){
		try {
			...
			if (tocken==null  ) {
				MessageManager mm = EngineMessage.get();
				throw new RQException("joinquant get_marginsec_stocks " + mm.getMessage("function.missingParam"));
			}
	
			Map<String, Object> paramMap = new HashMap<>();
			paramMap.put("method", "get_marginsec_stocks");
