...
public class ImIndustries extends ImFunction {
	public Node optimize(Context ctx) {
		return this;
	}
	//get_industries(token,code)
	public Object doQuery(Object[] objs){
		try {
			...
			if (tocken==null || code == null ) {
				MessageManager mm = EngineMessage.get();
				throw new RQException("joinquant get_industries " + mm.getMessage("function.missingParam"));
			}
	
			Map<String, Object> paramMap = new HashMap<>();
			paramMap.put("method", "get_industries");
