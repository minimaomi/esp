...
public class ImIndustryStocks extends ImFunction {
	public Node optimize(Context ctx) {
		return this;
	}
	//get_industry_stocks(token,code,date)
	public Object doQuery(Object[] objs){
		try {
			...
			if (tocken==null || code == null) {
				MessageManager mm = EngineMessage.get();
				throw new RQException("joinquant get_industry_stocks " + mm.getMessage("function.missingParam"));
			}
	
			Map<String, Object> paramMap = new HashMap<>();
			paramMap.put("method", "get_industry_stocks");
