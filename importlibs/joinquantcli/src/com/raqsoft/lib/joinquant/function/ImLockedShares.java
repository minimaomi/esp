...
public class ImLockedShares extends ImFunction {
	public Node optimize(Context ctx) {
		return this;
	}
	//get_locked_shares (token,code,date,end_date)
	public Object doQuery(Object[] objs){
		try {
			...
			if (tocken==null || code == null  ) {
				MessageManager mm = EngineMessage.get();
				throw new RQException("joinquant get_locked_shares " + mm.getMessage("function.missingParam"));
			}
	
			Map<String, Object> paramMap = new HashMap<>();
			paramMap.put("method", "get_locked_shares");
